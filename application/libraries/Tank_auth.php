...
class Tank_auth
{
	 ...
	 * @return	array
	 */
	function create_user($username, $firstname, $lastname, $email,/*$reg_number,*/$college_code,$phone,$birthday,$password, $email_activation)
	{
	 ...
	 * @return	array
	 */
	function create_user_oa2($email, $provider, $firstname, $lastname,$profile_image)
	{
