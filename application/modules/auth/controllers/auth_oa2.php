            ...
            try
            {
                ...
                //var_dump($user);
							...
							if ($this->tank_auth->is_logged_in()) {									// logged in
								...
								if (!is_null($data = $this->tank_auth->create_user_oa2($user['email'],$provider_name,$user['first_name'],$user['last_name'],$user['image']))) {
									// success
									$data['site_name'] = $this->config->item('website_name', 'tank_auth');
										...
										redirect('auth/auth_oa2/session/'.$provider_name);
