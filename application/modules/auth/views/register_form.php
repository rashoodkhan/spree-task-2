			...
			<div class="box01">
				<div class="login-window">
					...
					<div id="connect-with-buttons">
						<a href="<?php echo base_url()?>auth/auth_oa2/session/facebook" class="connect-with-button account-sprites account-sprites-facebook" title="Facebook Connect"></a>
						<a href="<?php echo base_url()?>auth/auth_oa2/session/google" class="connect-with-button marginleft13 account-sprites account-sprites-google" title="Google"></a>
					</div>
				</div>

		    <div style=margin-top:10px;>
		        &copy; <?php echo date("Y");?> by Campus.Net
		    </div>
